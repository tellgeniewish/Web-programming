	...
	<form name="frm3" method="post" action="calc_result.jsp">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="box" value="${ param.op1 }" name="op1" readonly>
                            <br><br>
                            ${ param.operator }
                            <br><br>
                            <input type="text" class="box" value="${ param.op2 }" name="op2" readonly>
                            <br><br>
                            =
                            <br><br>
                            <% int result = calc.calc(); %>
                            <input type="text" class="box" value="${ param.result }" readonly>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2"></th>
